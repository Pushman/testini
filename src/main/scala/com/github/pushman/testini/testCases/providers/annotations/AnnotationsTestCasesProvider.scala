...
import com.github.pushman.testini.testKits.{TestKit, TestKitProvider}
...
case class AnnotationsTestCasesProvider(testClass: TestClass, testKitsProviders: Seq[TestKitProvider])
